...
web console should be reachable — this machine (the default), your local network, or one address
such as a VPN interface; `--web-bind=localhost|lan|ADDR` answers it without the question and writes
